...
(function() {
  var canvas, canvas_height, canvas_width, ch, char_to_square, click_square, colors, ctx, current_color, draw_scenery, draw_square, find_pools, frames, grid, grid_left, grid_top, i, is_full, keys_down, load_file, load_puzzle, minutes, mouse_left, mouse_right, mouse_square, mouse_x, mouse_y, new_puzzle, pools, seconds, set_canvas, square_height, square_width, squares_high, squares_wide, _i, _j, _k, _l, _len, _len1, _m, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _results, _results1;
  ...
  set_canvas = function() {
    ...
    return canvas.height = canvas_height;
  };
  ...
  draw_square = function(val, x, y, color) {
  ...
  $(document).ready(function() {
    ...
    $(document).keydown(function(evt) {
      ...
      current_color = evt.which === 'Z'.charCodeAt(0) ? 'red' : evt.which === 'X'.charCodeAt(0) ? 'blue' : evt.which === 'C'.charCodeAt(0) ? 'green' : 'black';
      if (sq = mouse_square()) {
        r = sq[0], c = sq[1];
        click_square(r, c);
      }
    ...
    $(document).mousedown(function(evt) {
      var c, r, sq;
      current_color = keys_down['Z'.charCodeAt(0)] ? 'red' : keys_down['X'.charCodeAt(0)] ? 'blue' : keys_down['C'.charCodeAt(0)] ? 'green' : 'black';
      switch (evt.which) {
        case 1:
          mouse_left = true;
          if (sq = mouse_square()) {
      ...
      if ($('#running')[0].checked) {
        ...
        lines = [
          "Time: " + (pad2(minutes)) + ":" + (pad2(seconds)) + ";" + (pad2(frames)), "Mouse [" + mouse_left + ", " + mouse_right + "] at (" + mouse_x + ", " + mouse_y + ")", "Mouse square " + ((_ref6 = mouse_square()) != null ? _ref6.toString() : void 0), "Keys pressed: [" + (Object.keys(keys_down).toString()) + "]", "Pools: [" + (((function() {
            ...
            return _results2;
          })()).toString()) + "]", "Current color: " + current_color
        ];
