...
(function() {
  var canvas, canvas_height, canvas_width, click_square, ctx, draw_scenery, draw_square, frame, grid, grid_left, grid_top, keys_down, mouse_left, mouse_middle, mouse_right, mouse_square, mouse_x, mouse_y, new_puzzle, square_height, square_width, squares_high, squares_wide;
  ...
  $(document).ready(function() {
    ...
    return (animloop = function() {
      ...
      if ($('#running')[0].checked) {
        frame++;
        draw_scenery();
        lines = ["Frame " + frame, "Mouse " + mouse_left + ", " + mouse_middle + ", " + mouse_right + " at (" + mouse_x + ", " + mouse_y + ")", "Mouse square " + ((_ref = mouse_square()) != null ? _ref.toString() : void 0), "Keys at " + (Object.keys(keys_down).toString())];
