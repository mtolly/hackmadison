...
(function() {
  var canvas, ch, char_to_square, click_square, colors, ctx, current_color, draw_scenery, draw_square, find_pools, frames, grid, grid_left, grid_top, i, is_full, keys_down, load_file, load_puzzle, minutes, mouse_left, mouse_right, mouse_square, mouse_x, mouse_y, new_puzzle, pools, seconds, set_canvas, square_height, square_width, squares_high, squares_wide, _i, _j, _k, _l, _len, _len1, _m, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _results, _results1;
  ...
  set_canvas = function() {
    ...
    return canvas.height = squares_high() * square_height + 2 * grid_top;
  };
